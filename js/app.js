(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".hero-slider__slider")) new swiper_core_Swiper(".hero-slider__slider", {
                ...
                pagination: {
                    ...
                    renderCustom: function(swiper, current, total) {
                        return `\n\t\t\t\t\t<span className="hero-slider__swiper-pagination_current">${current.toString().padStart(2, 0)}</span>\n\t\t\t\t\t<span className="hero-slider__swiper-pagination_separator"></span>\n\t\t\t\t\t<span className="hero-slider__swiper-pagination_total">${total.toString().padStart(2, 0)}</span>\n\t\t\t\t\t`;
                    }
                },
                on: {}
            });
        ...
        function overlay() {
            ...
            overlay.addEventListener("click", (() => {
                htmlElement.classList.remove("header-menu-open");
            }));
        }
        menuInit();
        ...
        if (projectItems.length > 0) projectItems.forEach((el => {
            el.addEventListener("click", (event => {
                projectItems.forEach((item => {
                    if (item.classList.contains("project-card_active")) item.classList.remove("project-card_active");
                }));
                el.classList.toggle("project-card_active");
            }));
        }));
        window["FLS"] = false;
        isWebp();
